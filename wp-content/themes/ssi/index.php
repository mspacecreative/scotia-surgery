...
<div id="banner-container">
			<div id="banner-images-container" class="clearfix">
				<div id="location-shot">
					<img src="http://localhost/ssi/wp-content/themes/ssi/images/location-shot.jpg" class="location-shot">
				</div>
				<div id="slider-container" class="float">
					<ul class="rslides">
						<li><img src="http://localhost/ssi/wp-content/themes/ssi/images/reception.jpg"></li>
					  <li><img src="http://localhost/ssi/wp-content/themes/ssi/images/consultation.jpg" alt=""></li>
					  <li><img src="http://localhost/ssi/wp-content/themes/ssi/images/oral-operatory.jpg"</li>
					  <li><img src="http://localhost/ssi/wp-content/themes/ssi/images/continuing-education.jpg" alt=""></li>
					  <li><img src="http://localhost/ssi/wp-content/themes/ssi/images/operating-theatre.jpg" alt=""></li>
					  <li><img src="http://localhost/ssi/wp-content/themes/ssi/images/sterilization.jpg"</li>
					  <li><img src="http://localhost/ssi/wp-content/themes/ssi/images/recovery.jpg"</li>
					</ul>
				</div>
			</div>
		</div>
